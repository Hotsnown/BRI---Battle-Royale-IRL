...
import { ZonePresenter } from "./ZonePresenter"
...
class Map extends Component <any, any> {
  ...
  constructor(props) {
    ...
    async handleRadius() {
      const radius = fetch('https://cors-anywhere.herokuapp.com/https://us-central1-pubg-irl-261413.cloudfunctions.net/Starttimer')
        .then((response) => {
          return response.json();
        })
      const currentRadius:any = await radius
      this.setState({currentRadius:currentRadius["data"]})
    }
